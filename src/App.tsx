...
const stats = [
  { label: 'Repositories', value: 33, icon: FolderGit2, color: 'from-orange-500 to-amber-500' },
...
function App() {
  ...
  return (
    <div className="min-h-screen dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 bg-gradient-to-br from-white via-gray-50 to-white dark:text-white text-slate-900">
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'dark:bg-slate-900/95 bg-white/95 backdrop-blur-md shadow-lg shadow-orange-500/10' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex-shrink-0">
              <button onClick={() => scrollToSection('home')} className="text-2xl font-bold bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent hover:from-orange-400 hover:to-amber-500 transition-all">
                SD
              </button>
            </div>
              ...
              {['Home', 'About', 'Skills', 'Experience', 'Projects', 'CV', 'Contact'].map((item) => (
                <button
                  ...
                  className={`capitalize transition-all duration-300 relative px-3 py-2 ${activeSection === item.toLowerCase()
                      ? 'text-orange-500'
                      : 'dark:text-gray-300 text-slate-700 dark:hover:text-white hover:text-orange-500'
                    }`}
                >
                  {item}
            ...
            <button
              ...
              className="p-2 rounded-lg dark:hover:bg-slate-800 hover:bg-slate-200 transition-colors dark:text-gray-400 text-slate-500 hover:text-orange-500"
              ...
              {['Home', 'About', 'Skills', 'Experience', 'Projects', 'CV', 'Contact'].map((item) => (
                <button
                  ...
                  className={`block w-full text-left px-4 py-2 rounded-lg transition-colors ${activeSection === item.toLowerCase()
                      ...
                      : 'dark:text-gray-300 text-slate-700 dark:hover:bg-slate-800 hover:bg-slate-100 dark:hover:text-white hover:text-orange-500'
                    }`}
                >
                  {item}
                </button>
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(249,115,22,0.12),transparent_50%)]" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="flex-1 text-center lg:text-left">
              <div className="mb-4">
                <span className="text-orange-500 font-medium text-sm tracking-wider uppercase">— From Nepal</span>
              </div>

              <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-4 leading-tight">
                <span className="block dark:text-white text-slate-900">Hey, I'm</span>
                <span className="block bg-gradient-to-r from-orange-500 via-amber-500 to-orange-500 bg-clip-text text-transparent mt-1">
                  Swarup Dahal
                </span>
              </h1>
              ...
              <p className="text-lg sm:text-xl dark:text-gray-300 text-slate-700 mb-8 max-w-xl leading-relaxed">
                ...
                Currently diving deep into <span className="text-orange-500 font-medium">AI/ML</span> while keeping software honest through testing.
              </p>
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4">
                <button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-orange-600 to-amber-600 rounded-xl font-semibold text-white shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 hover:scale-105 transition-all duration-300"
                >
                  See my work
                </button>
                <button
                  onClick={() => scrollToSection('contact')}
                  className="px-8 py-4 dark:bg-slate-800/50 bg-white border border-orange-500/30 rounded-xl font-semibold text-orange-500 hover:bg-orange-500/10 hover:border-orange-500/50 transition-all duration-300"
                >
                  Say hello
                </button>
              </div>
            ...
            <div className="flex-1 flex justify-center lg:justify-end">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-orange-600 to-amber-600 rounded-full blur-2xl opacity-30 animate-pulse-slow" />
                <div className="relative w-64 h-64 sm:w-72 sm:h-72 rounded-full p-1 bg-gradient-to-r from-orange-600 to-amber-600">
                  <img
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 order-2 lg:order-1">
              <div className="inline-block">
                <span className="text-orange-500 font-semibold text-sm uppercase tracking-wider">About Me</span>
                <div className="mt-1 h-0.5 w-8 bg-gradient-to-r from-orange-400 to-amber-500 rounded-full" />
              </div>
              <h2 className="text-4xl sm:text-5xl font-bold dark:text-white text-slate-900 mt-4 mb-6 leading-tight">
                I break things <span className="text-orange-500">for a living</span> — and build them too
              </h2>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                {['AI/ML', 'Data Analysis', 'QA Automation', 'Python', 'C/C++'].map((tag) => (
                  <span key={tag} className="px-4 py-2 bg-orange-500/10 border border-orange-500/30 rounded-full text-orange-500 text-sm font-medium hover:bg-orange-500/20 transition-colors">
                    {tag}
                  </span>
                ))}
              </div>
            ...
            <div className="flex-1 order-1 lg:order-2">
              <div className="relative">
                <div className="absolute -top-4 -left-4 w-24 h-24 border-2 border-orange-400/30 rounded-2xl" />
                <div className="relative dark:bg-slate-800/80 bg-white rounded-2xl p-8 shadow-lg dark:shadow-orange-500/5 shadow-orange-500/10">
                ...
                <div className="absolute -bottom-4 -right-4 w-24 h-24 border-2 border-amber-400/30 rounded-2xl -z-10" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="skills" className="py-20 lg:py-32 dark:bg-slate-900/50 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-16">
            <div className="inline-block">
              <span className="text-orange-500 font-semibold text-sm uppercase tracking-wider">What I Know</span>
              <div className="mt-1 h-0.5 w-8 bg-gradient-to-r from-orange-400 to-amber-500 rounded-full" />
            </div>
            <h2 className="text-4xl sm:text-5xl font-bold dark:text-white text-slate-900 mt-4 leading-tight">
              Tools I actually <span className="text-orange-500">use</span>
            </h2>
          </div>

          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {/* Programming Languages */}
            <div className="dark:bg-slate-800/50 bg-white rounded-3xl p-8 shadow-lg dark:shadow-orange-500/5 shadow-orange-500/5 dark:border dark:border-slate-700/30 border border-slate-200/50">
                ...
                {skills.languages.map((skill) => (
                  <div key={skill.name}>
                    ...
                    <div className="h-2 dark:bg-slate-700 bg-slate-200 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-orange-600 to-amber-600 rounded-full transition-all duration-1000 ease-out"
            ...
            <div className="dark:bg-slate-800/50 bg-white rounded-3xl p-8 shadow-lg dark:shadow-orange-500/5 shadow-orange-500/5 dark:border dark:border-slate-700/30 border border-slate-200/50">
              ...
              <div className="flex flex-wrap gap-3">
                {skills.aiml.map((skill) => (
                  <span
                    key={skill}
                    className="px-4 py-3 bg-gradient-to-r from-orange-500/10 to-amber-500/10 border border-orange-500/30 rounded-xl text-orange-400 font-medium hover:bg-orange-500/20 hover:border-orange-400/50 transition-all duration-300"
                  >
                    {skill}
                  </span>
                ))}
              ...
              <div className="mt-8 pt-6 border-t dark:border-slate-700/50 border-slate-200">
                ...
                <div className="flex flex-wrap gap-2">
                  {skills.tools.map((tool) => (
                    <span
                      key={tool}
                      className="px-3 py-1.5 dark:bg-slate-700/50 bg-slate-100 border dark:border-slate-600/50 border-slate-300 rounded-lg dark:text-gray-300 text-slate-700 text-sm font-medium dark:hover:bg-slate-700 hover:bg-slate-200 hover:border-orange-500/50 transition-all duration-300"
                    >
                      {tool}
                    </span>
                  ))}
      ...
      <section id="experience" className="py-20 lg:py-32 dark:bg-slate-900/50 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-4">
            <div>
              <div className="inline-block">
                <span className="text-orange-500 font-semibold text-sm uppercase tracking-wider">My Journey</span>
                <div className="mt-1 h-0.5 w-8 bg-gradient-to-r from-orange-400 to-amber-500 rounded-full" />
              </div>
              <h2 className="text-4xl sm:text-5xl font-bold dark:text-white text-slate-900 mt-4 leading-tight">
                Where I've <span className="text-orange-500">worked</span>
              </h2>
            </div>
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            {experience.map((job, index) => (
              <div key={index} className="relative">
                <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-orange-500 to-amber-600 rounded-full" />

                <a
                  href={job.url}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block ml-8 p-8 dark:bg-slate-800/50 bg-white rounded-2xl dark:border dark:border-slate-700/50 border border-slate-200 hover:border-orange-500/50 dark:hover:bg-slate-800/70 hover:bg-slate-50 transition-all duration-300 group"
                >
                  <div className="absolute left-[-17px] top-8 w-9 h-9 rounded-full bg-gradient-to-r from-orange-600 to-amber-600 border-4 dark:border-slate-900 border-slate-200 group-hover:scale-110 transition-transform duration-300" />

                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                    <div>
                      <h3 className="text-2xl font-bold dark:text-white text-slate-900 group-hover:text-orange-500 transition-colors">{job.title}</h3>
                      <p className="text-orange-500 font-semibold mt-1">{job.company}</p>
                    </div>
                  ...
                  <ul className="space-y-2">
                    {job.achievements.map((achievement, i) => (
                      <li key={i} className="flex items-start gap-3 dark:text-gray-300 text-slate-700">
                        <span className="inline-block w-2 h-2 rounded-full bg-orange-400 mt-2 shrink-0" />
      ...
      <section id="projects" className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-16 gap-4">
            <div>
              <div className="inline-block">
                <span className="text-orange-500 font-semibold text-sm uppercase tracking-wider">My Work</span>
                <div className="mt-1 h-0.5 w-8 bg-gradient-to-r from-orange-400 to-amber-500 rounded-full" />
              </div>
              <h2 className="text-4xl sm:text-5xl font-bold dark:text-white text-slate-900 mt-4 leading-tight">
                Stuff I've <span className="text-orange-500">built</span>
              </h2>
            </div>
            <p className="dark:text-gray-400 text-slate-500 max-w-md lg:text-right">
            ...
            {projects.map((project, idx) => (
              <a
                ...
                className={`group relative dark:bg-slate-800/50 bg-white overflow-hidden dark:border dark:border-slate-700/30 border border-slate-200 transition-all duration-500 hover:scale-[1.02] ${
                  idx % 3 === 0 ? 'rounded-3xl shadow-lg dark:shadow-orange-500/5 shadow-orange-500/5' :
                  idx % 3 === 1 ? 'rounded-xl shadow-md dark:shadow-orange-500/5 shadow-orange-500/5' :
                  'rounded-2xl'
                }`}
              >
                <div className={`absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-orange-500 to-amber-600 transform origin-left transition-transform duration-500 ${
                  idx % 3 === 0 ? 'scale-x-100' : 'scale-x-0 group-hover:scale-x-100'
                }`} />

                <div className="relative p-8">
                  <div className="flex items-start justify-between mb-6">
                    <div className="w-14 h-14 rounded-xl bg-gradient-to-r from-orange-600 to-amber-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                      <project.icon className="w-7 h-7 text-white" />
                    </div>
                    <ExternalLink className="w-5 h-5 text-gray-500 group-hover:text-orange-500 transition-colors duration-300" />
                  </div>

                  <h3 className="text-xl font-bold dark:text-white text-slate-900 mb-3 group-hover:text-orange-500 transition-colors duration-300">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-3 py-1 dark:bg-slate-700/50 bg-slate-100 border dark:border-slate-600/50 border-slate-300 rounded-lg text-xs dark:text-gray-300 text-slate-700 group-hover:border-orange-500/30 transition-colors duration-300"
                      >
                        {tag}
                      </span>
                    ))}
      ...
      <section id="cv" className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl mb-16">
            <div className="inline-block">
              <span className="text-orange-500 font-semibold text-sm uppercase tracking-wider">My Resume</span>
              <div className="mt-1 h-0.5 w-8 bg-gradient-to-r from-orange-400 to-amber-500 rounded-full" />
            </div>
            <h2 className="text-4xl sm:text-5xl font-bold dark:text-white text-slate-900 mt-4 leading-tight">
              The official <span className="text-orange-500">document</span>
            </h2>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="relative rounded-2xl overflow-hidden border-2 dark:border-slate-700/50 border-slate-200 hover:border-orange-500/50 transition-all duration-300 group dark:bg-slate-800/50 bg-white p-2">
                  <img
              ...
              <div className="flex flex-col gap-6">
                <div className="dark:bg-slate-800/50 bg-white rounded-2xl p-6 border dark:border-slate-700/50 border-slate-200 hover:border-orange-500/50 transition-all duration-300 h-fit">
                  <div className="w-14 h-14 rounded-xl bg-gradient-to-r from-orange-600 to-amber-600 flex items-center justify-center mb-6">
                  ...
                  <a
                    ...
                    download
                    className="inline-flex items-center justify-center gap-2 w-full px-6 py-3 bg-gradient-to-r from-orange-600 to-amber-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-orange-500/50 transition-all duration-300 hover:scale-105"
                  >
                    <Download size={18} />
                    Download PDF
                  </a>
                ...
                <div className="dark:bg-slate-800/50 bg-white rounded-2xl p-6 border dark:border-slate-700/50 border-slate-200 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      <TestTube className="w-5 h-5 text-orange-500 flex-shrink-0 mt-0.5" />
                      <div>
          ...
          <div className="max-w-2xl mx-auto">
            <div className="dark:bg-slate-800/50 bg-white backdrop-blur-sm rounded-2xl p-8 sm:p-12 border dark:border-slate-700/50 border-slate-200">
              <div className="space-y-6">
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-orange-600 to-amber-600 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="flex items-center gap-4 p-4 dark:bg-slate-700/30 bg-slate-100 rounded-xl dark:hover:bg-slate-700/50 hover:bg-slate-200 transition-all duration-300 group"
                  >
                    <div className="w-12 h-12 rounded-xl dark:bg-slate-700 bg-slate-100 border dark:border-slate-600 border-slate-300 flex items-center justify-center group-hover:bg-orange-500/20 group-hover:border-orange-500/50 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="dark:text-gray-400 text-slate-500 text-sm">
              Made with <span className="text-orange-500">&#9829;</span> by Swarup Dahal &mdash; Nepal
            </div>
            <div className="flex items-center gap-4">
              {socialLinks.slice(0, 3).map((social) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="dark:text-gray-400 text-slate-500 hover:text-orange-500 transition-colors duration-300"
                >
                  <social.icon size={20} />
                </a>
              ))}
